!function (t, n) {
  ...
  function T(n, r, e, i, o) {
    ...
    return s ? function (t, n, r) {
      ...
      if (Array.isArray(n)) {
        ...
        return function (e) {
          var o = r(e);
          if (null == o) for (var u = 0; u < i; u++) t[u].removeAttribute(n); else for (var a = 0; a < i; a++) t[a].setAttribute(n, o)
        }
      }
      return function (e) {
        var i = r(e);
  ...
  function z(t, n) {
    ...
    return r ? function (t, n) {
      var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1 / 0,
        ...
        o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 1, u = t.length, a = e > 0 ? n : 0;
      i && r % 2 == 0 && (a = n - a);
      var l = null;
      return function (f, s) {
        var c = f % n, h = 1 + (f - c) / n;
        s *= e, i && h % 2 == 0 && (s = -s);
        var v = !1;
        if (h > r) c = a, v = !0, -1 === o && (c = e > 0 ? 0 : n); else if (s < 0 && (c = n - c), c === l) return !1;
        l = c;
    ...
    return e(t, [{
      key: '_rollback', value: function () {
        ...
        this._id = window.requestAnimationFrame((function e(i) {
          if (t._rollingBack) {
            null == r && (r = i);
            var o = i - r, u = t.rollbackStartOffset - o, a = Math.round(u * t.speed);
            if (a > t.duration && n != 1 / 0) {
              var l = !!t.alternate && a / t.duration % 2 > 1, f = a % t.duration;
              a = (f += l ? t.duration : 0) || t.duration
            }
            var s = t.fps ? 1e3 / t.fps : 0, c = Math.max(0, a);
            if (c < n - s) {
              t.offset = c, n = c;
      ...
      key: '_start', value: function () {
        var t = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, r = -1 / 0, e = null,
          i = {}, o = function o(u) {
            ...
            var a = Math.round((u - e + n) * t.speed), l = t.fps ? 1e3 / t.fps : 0;
      ...
      key: 'build', value: function (n, r) {
        return (n = function (t, n) {
          if (M = n, !t || !t.root || !Array.isArray(t.animations)) return null;
          for (var r = document.getElementsByTagName('svg'), e = !1, i = 0; i < r.length; i++) if (r[i].id === t.root && !r[i].svgatorAnimation) {
  ...
  var $ = {
      f: null, i: function (t, n, r) {
        return 0 === t ? n : 1 === t ? r : {x: w(t, n.x, r.x), y: w(t, n.y, r.y)}
      }, u: function (t, n) {
        return function (r) {
          var e = n(r);
      ...
      f: null, i: function (t, n, r) {
        return 0 === t ? n : 1 === t ? r : {width: w(t, n.width, r.width), height: w(t, n.height, r.height)}
      }, u: function (t, n) {
        return function (r) {
          var e = n(r);
    ...
    }, H = Math.sin, Y = Math.cos, Z = Math.acos, J = Math.asin, K = Math.tan, W = Math.atan2, X = Math.PI / 180,
    tt = 180 / Math.PI, nt = Math.sqrt, rt = function () {
      function t() {
      ...
      return e(t, [{
        ...
        key: 'rotateSelf', value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
          if (t %= 360) {
            var n = H(t *= X), r = Y(t), e = this.m, i = e[0], o = e[1];
        ...
        key: 'skewSelf', value: function (t, n) {
          if (n %= 360, (t %= 360) || n) {
            var r = this.m, e = r[0], i = r[1], o = r[2], u = r[3];
            t && (t = K(t * X), r[2] += e * t, r[3] += i * t), n && (n = K(n * X), r[0] += o * n, r[1] += u * n), this.w = this.s = this.i = null
          }
          return this
        }
      }, {
        key: 'resetSelf', value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
            ...
            o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, u = this.m;
        ...
        key: 'decompose', value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            ...
            e = r[0] * r[0] + r[1] * r[1], i = [[r[0], r[1]], [r[2], r[3]]], o = nt(e);
          if (0 === o) return {
            origin: {x: r[4], y: r[5]},
            translate: {x: t, y: n},
            scale: {x: 0, y: 0},
          ...
          i[1][0] /= l, i[1][1] /= l, a /= l;
          var f = 0;
          return i[1][1] < 0 ? (f = Z(i[1][1]) * tt, i[0][1] < 0 && (f = 360 - f)) : f = J(i[0][1]) * tt, u && (f = -f), a = W(a, nt(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * tt, u && (a = -a), {
            origin: {
              x: r[4],
              y: r[5]
            }, translate: {x: t, y: n}, scale: {x: o, y: l}, skew: {x: a, y: 0}, rotate: f
          }
        }
      }, {
  ...
  function st(n) {
    var r = function () {
      ...
      return n.style.position = 'absolute', n.style.opacity = '0.01', n.style.zIndex = '-9999', n.style.left = '-9999px', n.style.width = '1px', n.style.height = '1px', ft = {svg: n}
    }().svg;
  ...
  function vt(t, n, r, e) {
    var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, o = ht(t, n, r, e), u = ct(o);
    try {
      return u(i)
    } catch (t) {
      return null
  ...
  function gt(t, n, r, e) {
    var i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], o = vt(t, n, null, r, e);
    return o || (o = {x: yt(t.x, n.x, r.x, e), y: yt(t.y, n.y, r.y, e)}), i && (o.a = pt(t, n, r, e)), o
  }
  ...
  function wt(t, n, r, e, i) {
    var o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5], u = vt(t, n, r, e, i);
    return u || (u = {x: mt(t.x, n.x, r.x, e.x, i), y: mt(t.y, n.y, r.y, e.y, i)}), o && (u.a = xt(t, n, r, e, i)), u
  }
  ...
  var Bt = {
    ...
    'stroke-dasharray': {
      f: function (t) {
        ...
        var e, i, o, u = n.length, a = r.length;
        if (u !== a) if (0 === u) n = S(u = a, 0); else if (0 === a) a = u, r = S(u, 0); else {
...
__SVGATOR_PLAYER__.build({
  ...
  'animations': [{
    ...
    'elements': {
      'eh1KsGvlxtc2': {
        'transform': {
          'data': {
            's': {'x': 0.394245250775976, 'y': 0.394245250775976},
            't': {'x': 0, 'y': -7.283063041541027e-14}
          },
          'keys': {
            'o': [{'t': 0, 'v': {'x': 193.99403075, 'y': 151.96282374999998, 'type': 'corner'}}, {
              't': 6000,
              'v': {'x': 213.09612355, 'y': 164.91458054999998, 'type': 'corner'}
            }, {
              't': 6600,
              'v': {
                'x': 243.876923,
                'y': 189.046154,
                'type': 'cusp',
                'end': {'x': 417.98484250501053, 'y': 321.21934532740903}
              }
            }, {
              't': 7300,
              'v': {
                ...
                'y': 684.8348390000001,
                'type': 'cusp',
                'start': {'x': 598.1063792881741, 'y': 567.0015789550886}
              }
            }]
          }
        },
        'opacity': [{'t': 0, 'v': 0}, {'t': 2850, 'v': 1}, {'t': 3000, 'v': 0}, {'t': 3500, 'v': 0}, {
          't': 3600,
          'v': 1
        }, {'t': 4600, 'v': 1}, {'t': 4800, 'v': 0}, {'t': 5500, 'v': 0}, {'t': 5600, 'v': 1}, {
          't': 6000,
          'v': 1
        }, {'t': 7300, 'v': 0}]
      }
  ...
  'animationSettings': {'duration': 10000, 'direction': 1, 'iterations': 1, 'fill': 1, 'alternate': false, 'speed': 1}
})